...
st.write("Insira as especificações da peça para gerar a estimativa de Prazo e Custo através do modelo Random Forest.")
...
# Adicionando as 190 colunas do BERT PCA dinamicamente
